...
const VerifyResRegOtp = baseurl + 'GrievanceAuthorityVerifyResRegOtp'

export default class Authsignupotp extends React.Component {
  state = {
    phoneNumber: '',
    regOtp: '',
    showLoader:false
  ...
  handleSubmit = e => {
    // alert('helo')
    const verifyObj = {
      phoneNumber: this.props.navigation.state.params.JSON_ListView_Clicked_Item,
...
<View  style={{marginBottom:30,marginTop:10}}>
        ...
        <Form style={{ padding:5, width: 300,marginTop:0 }}>
                  ...
                  <Item  rounded  style={{paddingHorizontal:10}}>
                      ...
                      <Text  style={{borderColor:'#FFF',fontSize: 16,marginRight:5,padding:10}} >  {this.props.navigation.state.params.JSON_ListView_Clicked_Item} </Text>
                     </Item>
