...
export default class mystuffotherthenstf extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                 }
  ...
  render(){
    ...
    <Container>
                <View style={styles.container}>
                         <View   >
              <TouchableOpacity    onPress={() => this.props.navigation.navigate("issueassigntomeotherSTF")}>
...
Issues Assign to me
                ...
                <TouchableOpacity    onPress={() => this.props.navigation.navigate("IssuesClosedotehrSTF")}>
                <Card style={{ width:400,marginTop:-4}} >
                  <CardItem style={{ backgroundColor: '#FFFFF'}}>
                  <Text style={{ color:"#545454", fontWeight: 'bold', fontSize:16,justifyContent: 'center',paddingHorizontal:10,paddingVertical:10 }} >
                ...
                <TouchableOpacity    onPress={() => this.props.navigation.navigate("issueAssignBymeotherSTF")}>
                <Card style={{ width:400,marginTop:-4}} >
                  <CardItem style={{ backgroundColor: '#FFFFF'}}>
                  <Text style={{ color:"#545454", fontWeight: 'bold', fontSize:16,justifyContent: 'center',paddingHorizontal:10,paddingVertical:10 }} >
