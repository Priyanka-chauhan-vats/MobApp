...
const viewcomplaint = baseurl +'grievanceViewcompalint'; 

const paper =require("../Images/images1.jpg");

export default class Compaintdetails extends Component {
...
viewtable= ( ) => {
 const dataa = this.state.viewtable;
  ...
  console.log("view table")
  {
    dataa.map((item,index)=>(
      this.setState( {
        ...
        ConcernedNodalOfficer:item.ConcernedNodalOfficer,
        JurisdictionOrgComplaint:item.JurisdictionOrgComplaint
      })
    )
    )
  }
  ...
  const form1Obj = {
    ...
    JurisdictionOrgComplaint:this.state.languageJurisdictionOrgComplaint,
    ConcernedNodalOfficer:this.state.ConcernedNodalOfficer,
    // Photo:data
