...
const grievance2 = baseurl + 'all_grivencelistviewcomaplaint';
const grievance3 = baseurl + 'all_workinprogress'
    ...
    return (
      <Container>
        ...
        <View style={styles.container}>
          ...
          <View   >
            <TouchableOpacity onPress={() => this.props.navigation.navigate("actionNodalofc")}>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("actionNodalofcViewed")}>
              <Card style={{ width: 400, marginTop: -3 }} >
                <CardItem style={{ backgroundColor: '#FFFFF' }}>
                  <Text style={{
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("workinprogress")}>
...
<TouchableOpacity    onPress={() => this.props.navigation.navigate("onhold")}>

<Card style={{ width:400,marginTop:-3}} >
  <CardItem style={{ backgroundColor: '#FFFFF'}}>
    <Text style={{ width:'90%',color:"#545454", fontWeight: 'bold', fontSize:16,justifyContent: 'center',
    paddingHorizontal:10,paddingVertical:10 }}>
On Hold
</Text>
<Text >5</Text>
...
<TouchableOpacity    onPress={() => this.props.navigation.navigate("closed")}>
