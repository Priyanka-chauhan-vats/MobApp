...
const grievance = baseurl +'all_grivencelistotherthenstfViewed'; 
...
export default class  actionNodalofcViewedotherSTF  extends Component {
  constructor(props) {
    super(props);
    this.state = {
    choosenIndex: 0,
      ...
      <View style={{borderLeftWidth:1,borderRightWidth:1,}}  >
            {
               details.map((item, index) => (
                 ...
                 <TouchableOpacity    onPress={() => this.props.navigation.navigate("otherthenstfcomplaintdetailsViewed",[2,item._id])}>
