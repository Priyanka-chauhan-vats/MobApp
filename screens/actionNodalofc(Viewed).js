...
const grievance = baseurl +'all_grivencelistviewcomaplaint'; 
...
export default class  actionNodalofcViewed extends Component {
  constructor(props) {
    super(props);
    this.state = {
    choosenIndex: 0,
      ...
      <View style={{borderLeftWidth:1,borderRightWidth:1,}}  >
            {
               details.map((item, index) => (
                 ...
                 style = {styles.container}>
                     ...
                     <TouchableOpacity    onPress={() => this.props.navigation.navigate("detailsviewed",[2,item._id])}>
