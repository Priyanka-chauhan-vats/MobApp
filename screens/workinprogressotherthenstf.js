...
const grievance = baseurl +'all_workinprogressotehrthenstf'; 
// const car = require("../Images/car.jpg");
// const wood = require("../Images/wood.jpg");
// const iron = require("../Images/iron.jpg");
export default class  workinprogressotherthenstf extends Component {
  constructor(props) {
    super(props);
    this.state = {
    choosenIndex: 0,
    ...
    return (
     ...
     <View  style={{flexDirection:'row'}}>
         <Text style={{fontSize:15,fontWeight:'bold',marginLeft:5}} 
          ...
          <Text style={{fontSize:15,marginLeft:1}} 
          className="text-muted">In Progress
          </Text>
          </View>
          <View  style={{flexDirection:'row'}}>
         <Text style={{fontSize:15,fontWeight:'bold',marginLeft:5}} 
